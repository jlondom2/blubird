...
} from "./chunk-IZVWY5KC.js";
import {
  createWithBsPrefix,
  useCommittedRef_default,
  useEventCallback,
  useMergedRefs_default
} from "./chunk-K5BWEXMP.js";
import {
  DEFAULT_BREAKPOINTS,
...
var Carousel = React22.forwardRef((uncontrolledProps, ref) => {
  const {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component2 = "div",
    bsPrefix,
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react34.useMemo)(function() {
...
var Offcanvas = React60.forwardRef(({
  ...
  const renderBackdrop = (0, import_react35.useCallback)((backdropProps) => (0, import_jsx_runtime62.jsx)("div", {
    ...backdropProps,
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime74.jsxs)(import_jsx_runtime73.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react42.cloneElement)(children, triggerProps), (0, import_jsx_runtime72.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var Table = React78.forwardRef(({
  ...
  const classes = (0, import_classnames57.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size && `${decoratedBsPrefix}-${size}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
...
Tabs.defaultProps = defaultProps30;
